<!DOCTYPE html> <!-- Dasboar completo - SuperAdministrador (Agregar porductos)-->
...
<head>
	...
	<title>Agregar usuario</title> <!-- DASHBOARD DE HOBBIES PLACE-->
</head> 
<body>
...
<!--2.2 TOP NAVBAR/(Menu de Arriba)- TAREA: TOP NAVBAR para el Dasboard PERFIL DE USUARIO 12/01/2026-->
    <section class="main-view"> <!-- main-view es la que genera ese fondo gris.-->
        ...
        <div class="dashboard-content"> <!-- Contenedor del contenido del dashboard-->
            <!-- Tabla de usuarios metida hacia atras asi no oscutaliza la vista de agregar.-->
                    ...
                    <div class="header-title">
                        ...
                        <form class="filter-form">
                            <div class="input-group">
                                ...
                                <input type="text" id="nombre" placeholder="Insertar Nombre del Usuario">
                            </div>
                            <div class="input-group">
                                <label for="clave">Clave</label>
                                <input type="text" id="clave" placeholder="Insertar Clave del Usuario">
                            </div>
                            <div class="input-group">   <!-- Categoria -->
                                <label for="tipo">Rol</label>
                                <select id="tipo">      <!-- Select con opciones -->
                                    <option value="routers">Super-Administrador</option>
                                    <option value="antenas">Administrador</option>
                                    <option value="sublimables">Usuario</option>
                                </select>
                            </div>
                        </form> 
                    ...
                    <table><!--tabla completa -->
                            ...
                            <tr>
                                ...
                                <td>
                                    <div style="display: flex; flex-direction: column;">
                                        <span style="font-weight: 600;">Edgar Reyes</span>
                                        <small style="color: #64748b;">Última conexión: Hoy</small>
                                    </div>
                                </td>
                                <td><span class="role-badge"> <strong>Super Administrador</strong></span></td>
                                <td>hobbiesplacevzla@gmail.com</td>
                                <td><span class="status-pill status-success">Activo</span></td>
                        ...
                        <tbody><!-- F2 -->
                            <tr>
                                ...
                                <td>
                                    <div style="display: flex; flex-direction: column;">
                                        <span style="font-weight: 600;">Daniel Reyes</span>
                                        <small style="color: #64748b;">Última conexión: Ayer</small>
                                    </div>
                                </td>
                                <td><span class="role-badge"> <strong>Administrador secundario</strong></span></td>
                                <td>DanielReyes@email.com</td>
                                <td><span class="status-pill status-success">Activo</span></td>
                                <td> <!-- Botones para editar y eliminar -->
                                    <div class="action-buttons">
                                        <button class="btn-icon edit"><i class="fas fa-edit"></i></button>
                        ...
                        <tbody> <!-- F3 -->
                            <tr>
                                ...
                                <td>
                                    <div style="display: flex; flex-direction: column;">
                                        <span style="font-weight: 600;">Salvador Torres</span>
                                        <small style="color: #64748b;">Última conexión: Hoy</small>
                                    </div>
                                </td>
                                <td><span class="role-badge"> <strong>Usuario</strong></span></td>
                                <td>SalvadorTorrez@email.com</td>
                                <td><span class="status-pill status-danger">Inactivo</span></td>
                                <td><!-- Botones para editar y eliminar -->
                                    <div class="action-buttons">
                                        <button class="btn-icon edit"><i class="fas fa-edit"></i></button>
                                         <span class="status-pill status-danger">Desativar</span></td>
        ...
        <div id="modalUsuario" class="modal-container"> 
            <div class="modal-content">
                <div class="modal-header">
                    <h3><i class="fas fa-plus-circle"></i> Registrar Nuevo Usuario</h3>
                ...
                <form class="modal-form">
                    <div class="form-grid">
                        <div class="form-section">
                            <h4>Información Personal</h4>  <!-- Titulo-->
                            <div class="input-group">
                                <label for="user-fullname">Nombre Completo</label>
                                <input type="text" id="user-fullname" placeholder="Ej: Edgar Reyes" required>
                            </div>
                            <div class="input-group">
                                <label for="user-email">Correo Electrónico</label>
                                <input type="email" id="user-email" placeholder="nombre@gmail.com" required>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="input-group">
                                <label for="user-role">Asignar Rol</label>
                            ...
                            <div class="form-row">
                                ...
                                <div class="input-group">
                                    <label for="user-confirm">Confirmar</label>
                                    <input type="password" id="user-confirm" placeholder="••••••••" required>
                                </div>
                            </div>
                        </div>
                    </div>
