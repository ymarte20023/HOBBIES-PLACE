                    ...
                    <table><!--tabla completa -->
                        ...
                        <tbody> <!-- cuerpo principal de los datos/F1 -->
                            <tr>
                                ...
                                <td><strong>Catan Ampliación 5-6 Jugadores</strong></td>
                                <td><img src="/img/Catan1.png" alt="Catan1" width="50"></td>
                                <td>Juegos de mesa</td>
                                <td>Catán es un popular juego de mesa de estrategia y negociación, diseñado por Klaus Teuber, donde 3-4 jugadores compiten por colonizar una isla recolectando recursos</td>
                                <td>1</td>
                                <td><strong>20.706,00 Bs</strong></td>
                        ...
                        <tbody> <!--F2 -->
                            <tr>
                                ...
                                <td><strong>Catan Ciudades y Caballeros</strong></td>
                                <td><img src="/img/Catan2.png" alt="Catan2" width="50"></td>
                                <td>Juegos de mesa</td>
                                <td>Ciudades y Caballeros es una expansión estratégica avanzada para el juego base Catan, diseñada por Klaus Teuber, donde 3-4 jugadores deben desarrollar sus ciudades con mejoras, defender la isla de invasiones bárbaras</td>
                                <td>1</td>
                                <td><strong>24.956,00 Bs</strong></td>
                                <td><!-- Botones para agregar y eliminar productos -->
                                    <div class="action-buttons">
                                        <button class="btn-icon edit"><i class="fas fa-edit"></i></button>
                                        <span class="status-pill status-danger">Desativar</span></td>
                        ...
                        <tbody> <!-- F4 -->
                            <tr>
                                ...
                                <td><strong>Dungeon Raiders</strong></td>
                                <td><img src="/img/dungeon-raiders.jpg" alt="Dungeon Raiders" width="50"></td>
                                <td>Juegos de mesa</td>
                                <td>Juego de cartas rápido y semi-cooperativo (3-5 jugadores) diseñado por Phil Walker-Harding, enfocado en explorar una mazmorra en 5 niveles.</td>
                                <td>1</td>
                                <td><strong>13.303,75 Bs</strong></td>
                                <td><!-- Botones para agregar y eliminar productos -->
                                    <div class="action-buttons">
                                        <button class="btn-icon edit"><i class="fas fa-edit"></i></button>
                                        <span class="status-pill status-danger">Desativar</span></td>
                        ...
                        <tbody> <!-- F5 -->
                            <tr>
                                ...
                                <td><strong>luna capital</strong></td>
                                <td><img src="/img/luna-capital.jpg" alt="" width="50"></td>
                                <td>Juegos de mesa</td>
                                <td>juego de mesa familiar de gestión y colocación de losetas (tipo city building) para 1-4 jugadores (8+ años)</td>
                                <td>1</td>
                                <td><strong>23.946,75 Bs</strong></td>
                                <td><!-- Botones para agregar y eliminar productos -->
                                    <div class="action-buttons">
                                        <button class="btn-icon edit"><i class="fas fa-edit"></i></button>
                                        <span class="status-pill status-danger">Desativar</span></td>
                        ...
                        <tbody> <!-- F6 -->
                            <tr>
                                ...
                                <td><strong>La Selva Prohibida</strong></td>
                                <td><img src="/img/Selva-prophibida.jpg" alt="La Selva Prohibida" width="50"></td>
                                <td>Juegos de mesa</td>
                                <td>La Selva Prohibida es un juego de mesa cooperativo, diseñado por Matt Leacock, donde 2-5 jugadores deben escapar de un planeta alienígena hostil tras un aterrizaje de emergencia.</td>
                                <td>1</td>
                                <td><strong>21.286,00 Bs</strong></td>
                                <td><!-- Botones para agregar y eliminar productos -->
                                    <div class="action-buttons">
                                        <button class="btn-icon edit"><i class="fas fa-edit"></i></button>
                                        <span class="status-pill status-danger">Desativar</span></td>
