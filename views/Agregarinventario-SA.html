...
<head>
	...
	<title>Agregar Inventario</title> <!-- DASHBOARD DE HOBBIES PLACE-->
</head> 
<body>
        ...
        <div id="modalInventario" class="modal-container"> 
            <div class="modal-content">
                <div class="modal-header">
                    <h3><i class="fas fa-plus-circle"></i> Registrar Nuevo Producto</h3>
                ...
                <form class="modal-form">
                    <div class="form-grid">
                        <div class="form-section">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" id="prod-nombre" placeholder="Ej: Magic 60 – Card Theme Pirates" required>
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="input-group">
                                    <label for="prod-imagen">URL de la Imagen / Archivo</label>
                                    <input type="text" id="prod-imagen" placeholder="/img/nuevo-producto.png">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-row">
                                <div class="input-group">
                                    ...
                                    <input type="number" id="prod-stock" placeholder="0" min="0" required>
                                </div>
                                <div class="input-group">
                            ...
                            <div class="input-group">
                                <label for="prod-sku">ID / SKU Personalizado</label>
                                <input type="text" id="prod-sku" placeholder="Ej: #010">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-footer">
                        <div class="form-actions">
                            ...
                            <button type="submit" class="btn-main-action">Guardar en Inventario</button>
                        </div>
                    </div>
                </form>
            </div>
