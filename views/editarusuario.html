...
<head>
	...
	<title>Editar usuario</title> <!-- DASHBOARD DE HOBBIES PLACE-->
</head> 
<body>
                    ...
                    <table><!--tabla completa -->
                        ...
                        <tbody> <!-- F3 -->
                            <tr>
                                ...
                                <td><span class="status-pill status-success">Inactivo</span></td>
                                <td><!-- Botones para editar y eliminar -->
                                    <div class="action-buttons">
                                        <button class="btn-icon edit"><i class="fas fa-edit"></i></button>
                                        <span class="status-pill status-danger">Desativar</span></td>
        ...
        <!-- Editar usuarios-->
            <div class="modal-content">
                <div class="modal-header">
                    <h3><i class="fas fa-plus-circle"></i> Editar Usuario</h3>
                ...
                <form action="" method="post" class="modal-form">
                    <div class="form-section">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="username" name="username" placeholder="Ej: Edgar Reyes" required>
                        </div>
                        <div class="form-row">
                            <div class="input-group">
                                <label for="phone">Teléfono:</label>
                                <input type="tel" id="phone" name="phone" placeholder="+58 412-7915273" placeholder="Ej: +58...">
                            </div>
                            <div class="input-group">
                                <label for="email">Correo Electrónico:</label>
                                <input type="email" id="email" name="email" placeholder="nombre@email.com" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-section">
                        ...
                        <div class="input-group">
                            ...
                            <select id="role" name="role" required>
                                ...
                                <option value="admin_plus">Administrador secundario</option>
