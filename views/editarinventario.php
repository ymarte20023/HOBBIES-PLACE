...
<head>
	...
	<title>Editar Inventario</title> <!-- DASHBOARD DE HOBBIES PLACE-->
</head> 
<body>
            ...
            <div class="card-table">
                    ...
                    <div class="header-title">         
                        ...
                        <form class="filter-form">
                            <div class="input-group">
                                ...
                                <input type="text" id="nombre" placeholder="Insertar Nombre del Producto">
                            </div>
                ...
                <div class="table-responsive">  
                    <table><!--tabla completa -->
                        ...
                        <tbody> <!-- cuerpo principal de los datos/F1 -->
                            ...
                            <tr>
                                ...
                                <td><!-- Botones para agregar y eliminar productos -->
                                    <div class="action-buttons">
                                        ...
                                        <span class="status-pill status-danger">Desativar</span></td>
                                    </div>
                                </td>
                            </tr>
                        ...
                        <tbody> <!-- F1 -->
                            ...
                            <tr>
                                ...
                                <td><strong>Flexxfolio 360 18-Pocket – Blue</strong></td>
                                <td><img src="/img/FlexxfolioBlue.png" alt="Flexxfolio Blue" width="50"></td>
                                <td>Accesorios</td>
                                <td>Album para cartas coleccionables, color azul.</td>
                                <td>2</td>
                                <td><strong>16.290,75 Bs</strong></td>
                                <td><!-- Botones para agregar y eliminar productos -->
                                    <div class="action-buttons">
                                        <button class="btn-icon edit" title="Editar"><i class="fas fa-edit"></i></button>
                                        <span class="status-pill status-danger">Desativar</span></td>
                        ...
                        <tbody> <!-- F2 -->
                            <tr>
                                ...
                                <td><strong>Flexxfolio 360 18-Pocket – Red</strong></td>
                                <td><img src="/img/FlexxfolioRed.png" alt="Flexxfolio Red" width="50"></td>
                                <td>Accesorios</td>
                                <td>Album para cartas coleccionables, color rojo.</td>
                                <td>2</td>
                                <td><strong>16.290,75 Bs</strong></td>
                                <td><!-- Botones para agregar y eliminar productos -->
                                    <div class="action-buttons">
                        ...
                        <tbody> <!--F3 -->
                            <tr>
                                ...
                                <td><strong>Catan Navegantes</strong></td>
                                <td><img src="/img/Catan3.png" alt="Catan3" width="50"></td>
                                <td>Juegos de mesa</td>
                                <td>Catan: Navegantes es una expansión del popular juego de estrategia diseñada por Klaus Teuber, donde 3-4 jugadores expanden sus civilizaciones a través de múltiples islas, construyendo barcos y explorando nuevas rutas marítimas</td>
                                <td>1</td>
                                <td><strong>24.276,00 Bs</strong></td>
                                <td><!-- Botones para agregar y eliminar productos -->
                                    <div class="action-buttons">
                                        <button class="btn-icon edit" title="Editar"><i class="fas fa-edit"></i></button>
                                        <span class="status-pill status-danger">Desativar</span></td>
                        ...
                        <tbody> <!-- F3 -->
                            <tr>
                                ...
                                <td><strong>Sidewinder 100+ Xenoskin – Green</strong></td>
                                <td><img src="/img/SidewinderGreen.png" alt="Sidewinder Green" width="50"></td>
                                <td>Accesorios</td>
                                <td>Estuche robusto y elegante para mazos de cartas, color verde.</td>
                                <td>1</td>
                                <td><strong>13.963,50 Bs</strong></td>
                                <td><!-- Botones para agregar y eliminar productos -->
                                    <div class="action-buttons">
                                        <button class="btn-icon edit" title="Editar"><i class="fas fa-edit"></i></button>
                                        <span class="status-pill status-danger">Desativar</span></td>
                        ...
                        <tbody> <!-- F6 -->
                            ...
                            <td><strong>9</strong></td>
                                <td><strong>FlipTray 80+ Xenoskin – Purple</strong></td>
                                <td><img src="/img/FlipnTrayPurple.png" alt="FlipTray Purple" width="50"></td>
                                <td>Accesorios</td>
                                <td> Caja de cartas de alta calidad, de color púrpura.</td>
                                <td>2</td>
                                <td><strong>18.618,00 Bs</strong></td>
                                <td> <!-- Botones para agregar y eliminar productos -->
                                    <div class="action-buttons">
                                        <button class="btn-icon edit" title="Editar"><i class="fas fa-edit"></i></button>
                                        <span class="status-pill status-danger">Desativar</span></td>
        ...
        <!-- Editar productos-->
            <div class="modal-content">
                <div class="modal-header">
                    <h3><i class="fas fa-plus-circle"></i> Editar Producto</h3>
                    <button class="close-modal" type="button" title="Cerrar">&times;</button>
                </div>
                <form action="" method="post" class="modal-form">
                    <div class="form-section">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="prod-name" name="prod-name" placeholder="Ej: Yu-Gi-Oh! Phantom Revenge" required>
                        </div>
                        <div class="input-group">
                            <label for="prod-descripcion">Descripción del Producto</label>
                            <textarea id="prod-descripcion" rows="3" placeholder="Describe las características del producto..."></textarea>
                        </div>

                        <div class="form-row">
                            <div class="input-group">
                                <label for="prod-category">Categoría:</label>
                                <select id="prod-category" name="prod-category" required>
                                    <option value="electronica" selected>Accesorios</option>
                                    <option value="hogar">Cartas</option>
                                    <option value="oficina">Juegos de Mesa</option>
                                </select>
                            </div>
                            <div class="input-group">
                                <label for="prod-sku">Código / SKU:</label>
                                <input type="text" id="prod-sku" name="prod-sku" placeholder="PROD-001">
                            </div>
                        </div>
                    </div>
                    <div class="form-section">
                        <h4>Valores y Existencia</h4>
                        <div class="form-row">
                            <div class="input-group">
                                <label for="prod-stock">Stock Actual:</label>
                                <input type="number" id="prod-stock" name="prod-stock" placeholder="cantidad fisica en la tienda" required>
                            </div>
                            <div class="input-group">
                                <label for="prod-price">Precio Unitario (Bs):</label>
                                <input type="number" step="0.01" id="prod-price" name="prod-price" placeholder="0.00" required>
                            </div>
                        </div>
                    </div>
