<!DOCTYPE html> <!-- Dasboar- SuperAdministrador (HOME)-->
...
<head>
	...
	<title>Home</title> <!-- DASHBOARD DE HOBBIES PLACE-->
</head> 
<body>
...
<!--2.2 TOP NAVBAR/(Menu de Arriba)- TAREA: TOP NAVBAR para el Dasboard PERFIL DE USUARIO 12/01/2026-->
    <section class="main-view"> <!-- main-view es la que genera ese fondo gris.-->
        ...
        <div class="dashboard-content"> <!-- Contenedor del contenido del dashboard-->
            <h1>Bienvenido a Hobbies Place</h1>
        <!-- Alertas de Inventario -->
            <div class="stats-grid"> <!-- Contendor-->
                <div class="stat-card"> <!-- Contendor 1 (Ventas)-->
                    <div class="card-body">
                        <div class="icon-box bg-green">
                            <i class="fas fa-dolly"></i> </i> <!--Icono de Fon awesome (Fa dolly)-->
                        </div>
                        <div class="stat-info">
                    ...
                    <a href="#" class="card-footer">
                        Ir a salidas <i class="fa-solid fa-angles-right"></i>
                    </a>
                </div> <!-- Fin del Contendor-->
                
                <div class="stat-card"> <!-- Contendor 2 (Productos)-->
                    <div class="card-body">
                    ...
                    <a href="#" class="card-footer">
                        Ir a inventario <i class="fa-solid fa-angles-right"></i>
                    </a>
                </div> <!-- Fin del contendor-->
                
                <div class="stat-card"> <!-- Contendor 3 (Proveedores)-->
                    <div class="card-body">
                    ...
                    <a href="#" class="card-footer">
                        Ir a Proveedores <i class="fa-solid fa-angles-right"></i>
                    </a>
                </div> <!-- Fin del Contendor-->

                <div class="stat-card"> <!-- Contendor 4 (Usuarios)-->
                    <div class="card-body">
                    ...
                    <a href="#" class="card-footer">
                        Ir a Usuarios <i class="fa-solid fa-angles-right"></i>
                    </a>
                </div> <!-- Fin del contendor-->
            </div>
            ...
            <div class="alert-section">
                <div class="alert-header">ALERTAS DE INVENTARIO</div>
